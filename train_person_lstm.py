...
#                plt.plot(viewout[4][0], viewout[4][1],'y.')
            ...
            plt.pause(0.05)
            plt.savefig('D:\lstm_networks\dimkastan-learnpeopletrajectories-a37ad40d6d79\Trainmodel\Epoch_Imgs\epoch_' + str(epoch + 1) + '.png' )
...
for e in range(1,epoch-1):
    img_name = 'D:\lstm_networks\dimkastan-learnpeopletrajectories-a37ad40d6d79\Trainmodel\Epoch_Imgs\epoch_' + str(e + 1) + '.png'
    images.append(imageio.imread(img_name))
imageio.mimsave('D:\lstm_networks\dimkastan-learnpeopletrajectories-a37ad40d6d79\Trainmodel\Epoch_Imgs\generation_animation.gif', images, fps=5)